...
def main():
    ...
    try:
        ...
        # Ask user how long to generate data for
        try:
            duration_hours = float(input("Enter duration to generate data (in hours): "))
        except ValueError:
        ...
        logging.info(f"Starting data generation for {duration_hours} hours")
        ...
        while current_time < end_time:
            ...
            # Sleep a little to avoid overwhelming the broker in simulation mode
            # In a real scenario, we'd wait the full interval
            time.sleep(0.01)
        
        logging.info(f"Data generation complete. Generated {readings_count} readings.")
